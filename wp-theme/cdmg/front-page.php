	...
	<section class="logos">
		<div class="container">
			...
			<div class="logos__row">
				...
				<span>Humana</span>
				<span>Chevron</span>
				<span>1-800 Contacts</span>
				<span>The Weather Channel</span>
				<span>Sun Chlorella</span>
	...
	<section class="section section--navy">
		<div class="container">
			<div class="stats">
				...
				<div class="reveal"><div class="stat__num">126+</div><div class="stat__label">Awards to our founder</div></div>
		...
		<div class="container">
			...
			<div class="testi-track">
				<div class="testi reveal">
					...
					<p class="testi__text">"CDMG turned our direct response program into the most accountable line item in our marketing budget. We finally know what every dollar returns."</p>
					<div class="testi__who">Marketing Director<small>Consumer Health Brand</small></div>
				</div>
				<div class="testi reveal">
					<div class="testi__stars">&starf;&starf;&starf;&starf;&starf;</div>
					<p class="testi__text">"The team understands compliance and conversion at the same time. That combination is rare and it is exactly what our category requires."</p>
					<div class="testi__who">VP of Growth<small>Financial Products</small></div>
				</div>
				<div class="testi reveal">
					<div class="testi__stars">&starf;&starf;&starf;&starf;&starf;</div>
					<p class="testi__text">"Their direct mail and digital work together better than any agency we have used. The lift was immediate and it held as we scaled."</p>
					<div class="testi__who">Founder<small>Direct-to-Consumer Startup</small></div>
				</div>
				<div class="testi reveal">
					<div class="testi__stars">&starf;&starf;&starf;&starf;&starf;</div>
					<p class="testi__text">"Forty years of experience shows in the strategy. They have seen what works and they bring that judgment to every test."</p>
					<div class="testi__who">CEO<small>Established Product Company</small></div>
				</div>
			</div>
		</div>
	</section>
