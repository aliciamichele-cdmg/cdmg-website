	...
	<section class="section">
		<div class="container split">
			<div class="reveal">
				...
				<p style="margin:16px 0;">Integrated online strategies capture demand and convert attention into measurable action. From paid media to landing pages and email, every digital touch is built to perform and to be tracked.</p>
				<ul class="check-list">
